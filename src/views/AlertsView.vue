<template>
    <main class="container">
        <div class="d-flex align-items-center p-3 my-3 text-white bg-red rounded shadow-sm">
            <img class="me-3" src="/parks.png" alt="Parks logo" width="48" height="48" style="border-radius: 8px;" />
            <div class="lh-1">
                <h1 class="h6 mb-0 text-white lh-1">Parks Smart</h1>
                <small>Since 2023</small>
            </div>
        </div>

        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <h5 class="pb-2 mb-0" style="display: flex;">Recent updates</h5>
